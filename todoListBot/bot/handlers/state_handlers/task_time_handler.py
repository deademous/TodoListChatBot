...
class TaskTimeHandler(Handler):
    ...
    def can_handle(
        ...
        return state == "WAIT_TASK_TIME" and "message" in update and "text" in update["message"]
    ...
    def handle(
        ...
        task_id = storage.create_task(telegram_id, task_text, task_date, task_time_text)
        ...
        new_task = {
            "id": task_id, "text": task_text, "task_date": task_date, "task_time": task_time_text
        }
